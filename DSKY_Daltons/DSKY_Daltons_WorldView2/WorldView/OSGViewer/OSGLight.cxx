...
*OSGLight_maker = new SubContractor<OSGObjectTypeKey, OSGLight>("light");

static SubContractor<OSGObjectTypeKey, OSGStaticLight>
*OSGStaticLight_maker = new 
  SubContractor<OSGObjectTypeKey, OSGStaticLight>("static-light");

static SubContractor<OSGObjectTypeKey, OSGCenteredLight>
*OSGCenteredLight_maker = new 
  SubContractor<OSGObjectTypeKey, OSGCenteredLight>("centered-light");
