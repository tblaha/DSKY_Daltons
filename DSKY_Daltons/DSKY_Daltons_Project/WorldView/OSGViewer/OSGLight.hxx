...
/** OSGLight - a light object that can move with the world
    ...
    - direction vec3  - optional, onitial given. If non-zero, used, light is
                        spotlight
...
/** A light that can be moved by means of an attached objectmotion. 

    The light is part of a group that is child of a transform. One can add 
    a 3d model to the group to show, e.g. the lamp.
